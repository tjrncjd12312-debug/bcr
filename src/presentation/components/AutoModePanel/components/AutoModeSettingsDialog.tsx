...
export function AutoModeSettingsDialog({
  ...
  return (
    <div className={`ams-overlay ${animateIn ? 'visible' : ''}`} onClick={handleOverlayClick}>
      <div className={`ams-dialog ${animateIn ? 'visible' : ''}`}>
        {/* Header */}
        ...
        <div className="ams-tabs">
          <button
            className={`ams-tab ${activeTab === 'general' ? 'active' : ''}`}
            onClick={() => setActiveTab('general')}
          >
            일반
          </button>
          <button
            className={`ams-tab ${activeTab === 'strategy' ? 'active' : ''}`}
            onClick={() => setActiveTab('strategy')}
          >
            배팅 전략
          </button>
          <button
            className={`ams-tab ${activeTab === 'safety' ? 'active' : ''}`}
